...
因此，现在北邮计算机类学院有三个，分别为：**计算机学院（国家示范性软件学院）、网络空间安全学院、人工智能学院。**
...
3.考809专业课的专业有
>人工智能学院：智能科学与技术（学硕）、人工智能的5组和6组（专硕）。
...
#### 网络空间安全学院
!(2022/招生目录/网安院招生目录.png)
#### 人工智能学院
!(2022/招生目录/人工智能学院招生目录.png)
...
##### 院线
!(2022/院线/院线比较.jpg) 
1、学术学位学科专业：计算机科学与技术专业总分344分；软件工程（学术型）专业总分338分。
2、专业学位学科专业：计算机技术专业总分338分；软件工程（专业型）专业总分332分；大数据技术与工程专业总分273分。
**较21年对比:**
计算机学硕**降低**了8分，计算机专硕**上升**1分。
软件学硕**下降**10分，软件专硕**下降**17分。
...
**双机位**
!(2022/线上面试机位样图/抽象图.jpg) 
!(2022/线上面试机位样图/导师们一侧景象.jpg) 
!(2022/线上面试机位样图/真人图背后.jpg) 
!(2022/线上面试机位样图/真人图正面.jpg) 

##### 1.2 笔试
从20年开始，笔试因为疫情开始取消，这里简单介绍一下，复试笔试分为两类，一类叫做六选四，另一类叫做两门必考。
...
**时间：** 不少于20分钟
**提前准备的材料：** 个人简历+本科成绩单（盖章）+四六级证书+学院要求提交的材料

21复试采用线上面试的方式，所以与往年有很大的区别。面试主要是使用腾讯会议软件进行面试，面试分为等待环节和面试环节。首先每个组的同学在等待室进行等待，面试秘书会给同学们编好顺序，然后按照顺序依次进行面试。每个组大概5-6位老师，每位同学20分钟的时间。
首先由秘书向同学展示10多份试卷，每份试卷包括：英语考核问题、政治考核问题、基础知识考核问题、编程语言考核问题、算法类问题、每个组研究方向相关的问题。
>20线上面试问题举例
政治问题：
谈谈对新疆棉花事件的看法。
谈谈你大学期间印象最深的一段经历。
